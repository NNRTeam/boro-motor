...
namespace config {
    ...
    float constexpr MAX_LINEAR_VELOCITY_M_S = 0.65f;    // Maximum linear velocity in metter per second
    float constexpr MAX_ANGULAR_VELOCITY_RAD_S = 3.5f;    // Maximum angular velocity in radians per second

    float constexpr LINEAR_ACCELERATION_M_S2 = 2.0f;      // Linear acceleration in metter per second squared
    float constexpr LINEAR_DECCELERATION_M_S2 = 1.5f;    // Linear deceleration in meters per second squared
    ...
    float constexpr LINEAR_EMERGENCY_MAX_DECELEATION = 2.5f;
